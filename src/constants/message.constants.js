const messageHeader = {
  ...
  TASK_DELETING_FAILED: 'Deletion error.',
  ...
  LESSON_DELETING_FAILED: 'Deletion error.',
  LESSON_DELETED: 'Lesson successfully deleted.',
  ...
  COURSE_DELETING_FAILED: 'Deletion error.',
